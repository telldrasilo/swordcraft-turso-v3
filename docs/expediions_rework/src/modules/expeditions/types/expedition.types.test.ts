...
describe('DIFFICULTY_INFO', () => {
  ...
  it('should have correct level ranges', () => {
    ...
    expect(DIFFICULTY_INFO.easy.levelRange[1]).toBe(5);
    expect(DIFFICULTY_INFO.legendary.levelRange[0]).toBe(14);
    expect(DIFFICULTY_INFO.legendary.levelRange[1]).toBe(20);
  });
