 ...
 *
 * Ресурсы из локации:
 * - oak_wood, birch_wood (деревесина)
 * - iron_ore, coal (руды)
...
export const gatherWoodCommon: MissionTemplate = {
  ...
  resources: [
    { materialId: 'oak_wood', quantity: { base: 3, variance: 0.5, perDifficulty: 0, perRarity: 1 } },
    { materialId: 'birch_wood', quantity: { base: 2, variance: 0.5, perDifficulty: 0, perRarity: 1 } },
  ],
