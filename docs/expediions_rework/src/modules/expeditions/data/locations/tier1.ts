...
Дубы здесь старые и могучие, их кроны создают вечные сумерки внизу.`,
  ...
  resources: [
    ...
    { materialId: 'oak_wood', baseWeight: 100, rarity: 'common', minQuantity: 3, maxQuantity: 8 },
    { materialId: 'birch_wood', baseWeight: 80, rarity: 'common', minQuantity: 2, maxQuantity: 5 },
