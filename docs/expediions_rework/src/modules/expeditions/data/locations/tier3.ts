...
но который навсегда сохраняет холод после закалки.`,
  ...
  resources: [
    ...
    { materialId: 'stone', baseWeight: 80, rarity: 'common', minQuantity: 3, maxQuantity: 8 },
    { materialId: 'cold_iron_ore', baseWeight: 70, rarity: 'uncommon', minQuantity: 2, maxQuantity: 5 },
    { materialId: 'frost_iron', baseWeight: 25, rarity: 'rare', minQuantity: 1, maxQuantity: 3 },
...
ядовитые газы, пепельные бури. Но в этом пепле находят вулканическое стекло.`,
  ...
  resources: [
    ...
    { materialId: 'stone', baseWeight: 60, rarity: 'common', minQuantity: 2, maxQuantity: 6 },
    ...
    { materialId: 'obsidian_shard', baseWeight: 50, rarity: 'uncommon', minQuantity: 1, maxQuantity: 4 },
