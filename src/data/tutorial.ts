...
export const tutorialSteps: TutorialStep[] = [
  ...
  // Шаг 9: Гильдия — заказы
  {
    ...
    description:
      'NPC размещают заказы на оружие. Выполнение заказов даёт золото, славу и ценные награды. Славу можно обменять на рецепты. Дальше — вкладка «Экспедиции»: миссии с тем же расчётом прогноза и договора, что и в брифинге миссии.',
    icon: '📜',
    position: 'top',
  },
...
export const loadingTips = [
  ...
  'Износ и метки повреждений снимаются во вкладке «Ремонт» кузницы (техники и этапы)',
  'Во вкладке «Перековка» тратится душа войны с оружия на верстаке: усиление статов или рискованное пробуждение шрама',
]
