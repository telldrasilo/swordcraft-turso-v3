...
export const tutorialSteps: TutorialStep[] = [
  ...
  // Шаг 1: Ресурсы
  {
    ...
    title: 'Ресурсы',
    description:
      'Вверху — уровень кузнеца, золото 💰 и эссенция души. Полный запас материалов смотрите в энциклопедии и на складе по каталожным id; покупка базового сырья — в лавке.',
    icon: '📦',
    position: 'bottom',
  },
