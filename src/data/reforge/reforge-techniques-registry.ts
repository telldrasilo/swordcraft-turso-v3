...
export const REFORGE_TECHNIQUES: ReforgeTechniqueEntry[] = [
  {
    ...
    description:
      'Случайная прибавка к атаке в диапазоне от снимка клинка. Базовая техника: умеренная трата души войны, доступна при накопленной ДВ после нескольких миссий.',
  ...
  },
  {
    ...
    description:
      'Случайная прибавка к максимальной прочности от снимка. Базовая техника: умеренная трата ДВ после нескольких экспедиций.',
    reforgeType: 'buffStat',
    reforgeTier: T_BASIC,
    warSoulCost: 250,
    minGuildLevel: 1,
