...
export const advancedTechniques: Technique[] = [
  ...
  
  {
    ...
    name: 'Мастер-баланс',
    description:
      'Ещё один проход развесовки и проверки по осям: максимально ровный баланс для работы в руке, с дополнительным временем на подгонку.',
  ...
  
  {
    ...
    description:
      'Рельефная резьба по дереву или кости на рукояти и накладках: удобнее хват и богаче внешний вид.',
  ...
  
  {
    ...
    description:
      'Повторное пропитывание и дожим кожи после основного дубления — плотнее волокно, выше износостойкость на рукояти и обмотке.',
  ...
  
  {
    ...
    description:
      'Разная твёрдость по сечению клинка: режущая кромка твёрже, зона спинки упругее (как при клинковой закалке с мягкой спинкой). Нужен точный режим нагрева и охлаждения; ошибка даёт риск трещины.',
