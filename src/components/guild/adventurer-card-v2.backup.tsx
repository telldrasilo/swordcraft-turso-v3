    ...
    >
      ...
      >
        <CardContent className="p-3 space-y-2 flex-1 flex flex-col overflow-hidden">
                ...
                <TooltipProvider key={trait.id}>
                  <Tooltip>
                    <TooltipTrigger>
                      <Badge 
                        variant="outline" 
                        className="text-xs px-2 py-1 bg-purple-900/40 text-purple-200 border-purple-500/50 font-medium"
                      >
          ...
          {/* ===== СИЛЬНЫЕ СТОРОНЫ И СЛАБОСТИ — СКРЫТО В DETAILS ===== */}
          <details className="group">
            <summary className="cursor-pointer text-xs text-amber-400 hover:text-amber-300 flex items-center gap-1 list-none select-none">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          ...
                          <div className="mt-1 pt-1 border-t border-stone-600 text-xs space-y-0.5">
                            ...
                            {data.effects.refusalChanceBonus > 0 && <p className="text-orange-300">✗ Отказ: +{data.effects.refusalChanceBonus}%</p>}
                          </div>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
          ...
          {/* ===== АНАЛИТИКА ПРЕДСКАЗАНИЯ МИССИИ — КОМПАКТНАЯ ВЕРСИЯ ===== */}
            ...
            <div className="flex items-center justify-between">
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p className="font-semibold text-amber-400">Расчёт результатов миссии</p>
                    <p className="text-xs text-stone-300">
                  ...
                  <Tooltip>
                    <TooltipTrigger>
                      <span className={`text-[10px] px-1.5 py-0.5 rounded cursor-help ${
                        ...
                        {advice.icon} {advice.text.length > 15 ? advice.text.slice(0, 15) + '...' : advice.text}
                      </span>
                    </TooltipTrigger>
                    <TooltipContent>
