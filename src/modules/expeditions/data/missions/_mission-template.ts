...
import type { ExpeditionMissionType } from '@/types/expedition-domain';
...
/** Типы миссий модуля (без legacy `magic` только в старых шаблонах хоста) */
export type MissionType = Exclude<ExpeditionMissionType, 'magic'>;
